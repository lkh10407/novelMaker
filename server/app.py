...
from .api import projects, characters, settings, outline, generate, export, collab, media, animation
...
app.include_router(animation.router, prefix="/api/projects", tags=["Animation"])
